...
export const socialMediaProfiles = [
  ...
  {
    title: 'GitHub',
    href: 'https://github.com/ponomoly-dev',
    icon: GitHubIcon,
  },
  {
    title: 'LinkedIn',
    href: 'https://www.linkedin.com/in/%ED%98%84%EC%A4%80-%EC%A3%BC-6b3617227/',
    icon: LinkedInIcon,
  },
];
    ...
    >
      {socialMediaProfiles.map((socialMediaProfile) => (
        <li key={socialMediaProfile.title}>
          ...
          >
            <socialMediaProfile.icon className="h-9 w-9 fill-current" />
          </Link>
        </li>
      ))}
    </ul>
